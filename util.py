...
def sync_labels2meta_reminders(gtd_date_next_action_pages):
    ...
    gtd_reminders = [
        reminder for page in gtd_date_next_action_pages for reminder in page.reminder
    ]
    reminder_to_make_in_todoist = [
        reminder for reminder in gtd_reminders if reminder not in meta_reminder_names
    ]
    ...
    reminders_to_delete = [
        ...
        if reminder_name not in gtd_reminders
    ]
